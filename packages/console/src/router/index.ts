...
const routes: RouteRecordRaw[] = [
  ...
  { path: "/", name: "root", component: () => import("../views/RootResolver.vue") },
  ...
  { path: "/e/:env/secrets/browse/:path*", name: "secrets-browse", component: () => import("../views/SecretsCatalog.vue"), props: true },
  ...
  // params) is not enough to reach it.
  {
    ...
    props: (route) => ({ env: route.params.env, path: firstQueryValue(route.query.path) }),
  },
...
const firstQueryValue = (value: string | null | (string | null)[] | undefined): string | undefined =>
